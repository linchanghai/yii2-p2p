...
$this->title = $model->project_invest_empiric_id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('p2p_project', 'Project Invest Point Records'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="project-invest-empiric-record-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a(Yii::t('p2p_project', 'Delete'), ['delete', 'id' => $model->project_invest_empiric_id], [
