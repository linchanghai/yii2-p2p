...
class WithdrawRecordSearch extends WithdrawRecord
{
    ...
    public function searchAUTO($params)
    {
        $model = Kiwi::getWithdrawRecord();
        $query = $model::find()->where(['deposit_type'=>$model::TYPE_AUTO]);
    ...
    {
        $model = Kiwi::getWithdrawRecord();
        $query = $model::find()->where(['deposit_type'=>$model::TYPE_MANUAL,'status'=>$model::STATUS_PENDING]);
    ...
    {
        $model = Kiwi::getWithdrawRecord();
        $query = $model::find()->where(['deposit_type'=>$model::TYPE_MANUAL,'status'=>$model::STATUS_SUCCESS]);
    ...
    public function searchFail($params)
{
    $model = Kiwi::getWithdrawRecord();
    $query = $model::find()->where(['deposit_type'=>$model::TYPE_MANUAL,'status'=>$model::STATUS_FAIL]);
    ...
    {
        $model = Kiwi::getWithdrawRecord();
        $query = $model::find()->where(['deposit_type'=>$model::TYPE_MANUAL,'status'=>$model::STATUS_FIRST_VERIFY_SUCCESS]);
