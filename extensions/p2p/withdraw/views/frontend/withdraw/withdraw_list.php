...
<div class="containerMain">
    ...
    <div class="backGrey p20 fundsRecords">
        <div class="clearFix mt10 filterLine">
            <label>时间范围:</label>
            <a <?= Yii::$app->request->get('date') ? null : 'class="active"'?> href="<?= Url::to(array_merge(\Yii::$app->request->queryParams,['/withdraw/withdraw/withdraw-list','date'=>0]))?>">全部</a>
            <a <?= Yii::$app->request->get('date')==1 ? 'class="active"':null ?> href="<?= Url::to(array_merge(\Yii::$app->request->queryParams,['/withdraw/withdraw/withdraw-list','date'=>1]))?>">一个月以内</a>
