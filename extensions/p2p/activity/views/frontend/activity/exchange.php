...
<div class="container mt20 couponExchange">
    ...
    <?= Html::hiddenInput('id', $productMapModel->product_map_id); ?>
    ...
    <div class="mt40"><label class="col666">换购积分: </label><span
            id="leastLine"><?= $productMapModel->exchange_points ?></span></div>
    ...
    <div class="clearFix mt20 myIntegralItem">
        <?= Html::submitButton('换购', ['class' => 'fl btn regularBtn mr16']) ?>
        <div class="fl ml10 myIntegralArea">
            我的积分: <span id="myIntegral"
                        class="themeColor"><?= Yii::$app->user->identity->memberStatistic->points ?></span>
        </div>
    </div>
    <div class="mt10">
        ...
        <div class="investSingleRule">
            <table class="table tableNoBorder investSingleRule1">
                ...
                <tr>
                    ...
                    <td>
                        钻点<?= $productMapModel->exchange_value ?><?= ($productMapModel->type != $productMapModel::CouponAnnual) ? '元' : '%' ?><?= $type[$productMapModel->type] ?></td>
                </tr>
                <tr>
