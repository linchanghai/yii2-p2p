...
$this->title = Yii::t('p2p_activity', 'Update {modelClass}: ', [
    'modelClass' => 'Coupon Cash Record',
]) . ' ' . $model->coupon_cash_record_id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('p2p_activity', 'Coupon Cash Records'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->coupon_cash_record_id, 'url' => ['view', 'id' => $model->coupon_cash_record_id]];
$this->params['breadcrumbs'][] = Yii::t('p2p_activity', 'Update');
?>
<div class="coupon-cash-record-update">
