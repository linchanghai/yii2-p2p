...
<div class="container twoContainer">
    <div class="containerSide accountSide" id="accountSide">
        ...
        <dl class="<?= in_array(Yii::$app->request->pathInfo,['/member/member/member-info'] )?'current':''?>">
            <dt ><a href="#"><i class="glyphicon glyphicon-user fs16"></i>个人信息</a></dt>
            <dd  class="<?= in_array(Yii::$app->request->pathInfo,[ 'member/member/member-info'])?'active':''?>"><a href="<?= Url::to(['/member/member/member-info'])?>">基本信息</a></dd>
            <dd><a href="#">密码设置</a></dd>
            <dd><a href="#">我的消息</a></dd>
        </dl>
        <dl class="<?= in_array(Yii::$app->request->pathInfo,['member/member-coupon/bonus-view','member/member-coupon/annual-view','member/member-coupon/cash-view'] )?'current':''?>">
            ...
            <dd class="<?= in_array(Yii::$app->request->pathInfo,[ 'member/member-coupon/bonus-view','member/member-coupon/annual-view','member/member-coupon/cash-view'])?'active':''?>"><a href="<?= Url::to(['/member/member-coupon/bonus-view'])?>">我的优惠券</a></dd>
            <dd><a href="#">邀请好友</a></dd>
        </dl>
    </div>
<?= $content;?>
