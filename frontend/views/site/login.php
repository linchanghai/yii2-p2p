...
/* @var $model \core\user\forms\LoginForm */

$this->registerCssFile(Yii::$app->urlManager->baseUrl . '/css/account.min.css', ['depends' => [AppAsset::className()]]);

$this->registerJsFile(Yii::$app->urlManager->baseUrl . '/js/account.js', ['depends' => [AppAsset::className()]]);

?>
<div class="container backGrey loginWrap">
    <div class="clearFix">
        <div class="fr fs16">没有帐号? <a href="<?= Url::to(['/site/signup']) ?>" class="secondColor">立即注册</a></div>
    </div>
    ...
    <div class="formGroup mt20 clearFix">
        <label class="fl rememberMe" for="rememberMe"><input type="checkbox" class="prt2" id="rememberMe"
                                                             name="LoginForm[rememberMe]" value=1 checked>记住我</label>
